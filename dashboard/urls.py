...
urlpatterns = [
    ...
    path('products/new_product/', views.AdminProductCreateView.as_view(), name='admin_product_create'),
    path('products/new_category/', views.AdminCategoryCreateView.as_view(), name='admin_category_create'),
